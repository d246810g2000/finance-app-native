    ...
    const handleSave = () => {
        ...
        Object.entries(localBudgets).forEach(([category, limit]) => {
            ...
            if (numericLimit > 0) {
                ...
                newRules.push({
                    id: existing ? existing.id : `cat-${category}`,
                    category,
                    ...
                    <View style={styles.header}>
                        <View style={{ flex: 1 }}>
                            ...
                            <Pressable onPress={handleSmartFill} style={styles.smartBtn}>
                                {loading ? <ActivityIndicator size="small" color={colors.primary} /> : <Text style={styles.smartBtnText}>智慧填入 (3個月平均)</Text>}
                            </Pressable>
                        </View>
...
const createStyles = (colors: AppColors) => StyleSheet.create({
    ...
    smartBtnText: { color: colors.primary, fontWeight: '600', fontSize: 14 },
    ...
    amountInputContainer: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: colors.border, borderRadius: 8, paddingHorizontal: 12, backgroundColor: colors.surface, width: 140 },
